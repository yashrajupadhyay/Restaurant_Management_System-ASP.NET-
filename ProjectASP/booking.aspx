                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                <a href="booking.aspx" class="dropdown-item active">Booking</a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="position-relative mx-auto" style="max-width: 400px;">
                         <%--   <input class="form-control border-primary w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email">--%>
                            <asp:TextBox ID="TextBox4" class="form-control border-primary w-100 py-3 ps-4 pe-5" placeholder="Your email" runat="server" OnTextChanged="TextBox4_TextChanged"></asp:TextBox>
