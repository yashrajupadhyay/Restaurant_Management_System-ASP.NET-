<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="ProjectASP.contact" %>
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                           <%-- <textarea class="form-control" placeholder="Leave a message here" id="message" style="height: 150px"></textarea>
                                            ...
                                            <asp:TextBox ID="txtmessage" class="form-control" placeholder="Leave a message here"  style="height: 150px" runat="server"></asp:TextBox>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="position-relative mx-auto" style="max-width: 400px;">
                            ...
                            <asp:TextBox ID="TextBox5" class="form-control border-primary w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email" runat="server"></asp:TextBox>
