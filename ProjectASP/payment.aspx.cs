...
namespace ProjectASP
{
    public partial class payment : System.Web.UI.Page
    {
        ...
        protected void btnPlaceOrder_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand insertCmd = new SqlCommand("INSERT INTO Order_tbl (Cart_Id, User_Id, Product_Id) VALUES (@Cart_Id, @User_Id, @Product_Id)", con);
            ...
            // Step 3: Optional - Clear the cart
            SqlCommand deleteCmd = new SqlCommand("DELETE FROM Cart WHERE UserId = @UserId", con);
