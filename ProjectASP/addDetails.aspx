<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="addDetails.aspx.cs" Inherits="ProjectASP.addDetails" %>
...
<body>
    ...
    <div class="container text-center my-5 pt-5 pb-4">
        <h1 class="display-3 text-white mb-3 animated slideInDown">Address Detail</h1>
    </div>
</div>
...
<div class="container text-center my-5">
    <div class="card p-4" style="background-color: #d9d9d9; max-width: 500px; margin: auto; border-radius: 10px;">
        <h3 style="font-weight: bold; text-decoration: underline; color: #000;">Address</h3>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
   <div class="form-container">
    <asp:Panel ID="pnlOrderForm" runat="server">
        <div class="form-field">
            <asp:TextBox ID="txtName" runat="server" Placeholder="Your Name" CssClass="form-control" />
           <asp:TextBox ID="txtPhone" runat="server" Placeholder="Your Phone No." CssClass="form-control" />
