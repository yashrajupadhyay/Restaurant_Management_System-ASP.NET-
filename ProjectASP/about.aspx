<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="ProjectASP.Aboutus" %>
...
<%--                            <input class="form-control border-primary w-100 py-3 ps-4 pe-5" type="text" placeholder="Your email">--%>
                            <asp:TextBox ID="TextBox1" class="form-control border-primary w-100 py-3 ps-4 pe-5" runat="server"></asp:TextBox>
                           <%-- <button type="button" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">SignUp</button>--%>
                            <asp:Button ID="Button1" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2"  runat="server" Text="Button" />S
                        </div>
                    </div>
                </div>
            </div>
